...
func (m *MockCar) CarCreate(arg0 context.Context, arg1 *model.Car) (*model.Car, error) {
	m.ctrl.T.Helper()
...
func (m *MockCar) CarGet(arg0 context.Context, arg1 uuid.UUID) (*model.Car, error) {
	m.ctrl.T.Helper()
...
func (m *MockCar) CarGetByBrand(arg0 context.Context, arg1 string, arg2 bool) ([]*model.Car, error) {
	m.ctrl.T.Helper()
...
func (m *MockCar) CarUpdate(arg0 context.Context, arg1 *model.Car) (*model.Car, error) {
	m.ctrl.T.Helper()
...
func (m *MockEngine) EngineCreate(arg0 context.Context, arg1 *model.Engine) (*model.Engine, error) {
	m.ctrl.T.Helper()
...
func (m *MockEngine) EngineGet(arg0 context.Context, arg1 uuid.UUID) (*model.Engine, error) {
	m.ctrl.T.Helper()
...
func (m *MockEngine) EngineUpdate(arg0 context.Context, arg1 *model.Engine) (*model.Engine, error) {
	m.ctrl.T.Helper()
